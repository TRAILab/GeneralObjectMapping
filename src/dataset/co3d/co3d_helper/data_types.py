# Source: https://github.com/facebookresearch/co3d/blob/87216bdeba922aa52c1ef2d99998cf6ff5b37efb/co3d/dataset/data_types.py
...
from typing import IO, Any, Dict, Optional, Tuple, Type, TypeVar, Union, cast
...
def _dataclass_from_dict(d, typeannot):
    ...
    if issubclass(cls, tuple) and hasattr(cls, "_fields"):  # namedtuple
        ...
        key_t, val_t = get_args(typeannot)
        return cls(
            (_dataclass_from_dict(k, key_t), _dataclass_from_dict(v, val_t)) for k, v in d.items()
        )
    elif not dataclasses.is_dataclass(typeannot):
        return d
